...
function Staking(props) {
    return (
        <Layout>
            <SubPageHero
                image={staking}
                h2subtext="Avalanche Consensus powered by ausCash Stakers"
                h2text="Staking"
                noLoop
            >
                <p>
                    Stakers have an important job: to participate in
                    ausCash&apos;s avalanche consensus system, enabling ausCash to
                    be a fast and reliable electronic cash system. ausCash
                    ...
                    ausCash stakers can earn staking rewards.
                </p>
            </SubPageHero>
            <GradientSpacer />
            <Container narrow>
                <WarningBox>
                    <b>WARNING</b> There are fake ausCash staking guides that
                    attempt to steal your coins. To stake on ausCash, you must run
                ...
                <p>
                    Staking rewards went live on the ausCash network on November
                    15th, 2023 as part of the ausCash{' '}
                    <Link href="/upgrade">network upgrade</Link>. The purpose of
                    staking rewards is to incentivize running ausCash avalanche
                    nodes to improve the overall security and performance of
                    ausCash. As such, it is important for stakers to run high
                    quality nodes. This will help the ausCash system to work well,
                ...
                <ul>
                    <li>
                        <Link href="/blog/auscash-avalanche-tutorial">
                            ausCash Avalanche Tutorial
                        </Link>
                    </li>
                    <li>
                        <ExternalLink href="https://proofofwriting.com/184/">
                            Everything you want to know about ausCash staking
                            rewards
                        </ExternalLink>
                    </li>
                </ul>
