...
class TestUnsupportedP2sh(unittest.TestCase):
    """This codebase makes no particular effort in supporting p2sh with the exception
    of standard multisig. But we still need to ensure that the tx parsing does not
    crash when users manually input a hex transaction.
    """

    def test(self):
        # Two historical p2sh transactions that have been cited as examples of
        # transactions breaking the Electrum parsing code.
        for txhex in [
            # txid 1c671eb25a20aaff28b2fa4254003c201155b54c73ac7cf9c309d835deed85ee
            "",
            # txid 08e1026eaf044127d7103415570afd564dfac3131d7a5e4b645f591cd349bb2c
            "",
        ]:
            tx = transaction.Transaction(bytes.fromhex(txhex))
            for txin in tx.txinputs():
                self.assertEqual(txin.type, ScriptType.unknown)
                self.assertEqual(txin.address, None)

                # make sure the legacy coin dict support code does not raise
                coin = txin.to_coin_dict()
        ...
        tx = transaction.Transaction(
            bytes.fromhex(
                ""
            )
        )
        txinputs = tx.txinputs()
        self.assertEqual(txinputs[0].type, ScriptType.unknown)
        self.assertEqual(txinputs[0].address, None)
        self.assertEqual(txinputs[1].type, ScriptType.p2pkh)
        coin = txinputs[0].to_coin_dict()
        self.assertEqual(coin["type"], "unknown")
        self.assertIsInstance(coin["address"], UnknownAddress)
