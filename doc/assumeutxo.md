...
Assumeutxo is a feature that allows fast bootstrapping of a validating ausd
...
- A new block index `nStatus` flag is introduced, `ASSUMED_VALID_FLAG`, to mark block
...
considered active. This is the "traditional" mode of operation for ausd.
