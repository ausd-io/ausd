# Support for Output Descriptors in ausd

Since ausd v0.20.7, there is support for Output Descriptors. This is a
...
existing ausd wallets, a convenience function `combo` is provided,
...
All RPCs in ausd will include the checksum in their output. Only
