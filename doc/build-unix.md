UNIX BUILD NOTES
====================
Some notes on how to build ausd in Unix.
...
This will build aus-qt as well.

Dependencies
---------------------

*Note: ausd provides a [Docker image with all the dependencies preinstalled](#build-using-a-docker-container).*
...
memory available when compiling ausd. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build ausd without wallet.
...
If you want to build aus-qt, make sure that the required packages for Qt development
...
Notes
-----
The release is built with GCC and then "strip ausd" to strip the debug
...
Security
--------
To help make your ausd installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, ausd should be built with a non-executable stack,
