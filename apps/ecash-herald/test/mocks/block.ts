...
const mockedBlock: any = {
    ...
    parsedBlock: {
        ...
        miner: 'unknown, ...863u',
        staker: {
            staker: 'auscash:qrpkjsd0fjxd7m332mmlu9px6pwkzaufpcn2u7jcwt',
            reward: 62500000,
        },
        numTxs: 27,
        parsedTxs: [
