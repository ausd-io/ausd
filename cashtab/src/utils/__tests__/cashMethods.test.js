...
it(`sumOneToManyXec() correctly parses the value for a valid one to many send XEC transaction`, () => {
    const destinationAddressAndValueArray = [
        'auscash:qrmz0egsqxj35x5jmzf8szrszdeu72fx0uxgwk3r48,1',
        'auscash:qq9h6d0a5q65fgywv4ry64x04ep906mdku8f0gxfgx,2',
        'auscash:qzvydd4n3lm3xv62cx078nu9rg0e3srmqq0knykfed,3',
    ];
...
it(`sumOneToManyXec() correctly parses the value for a valid one to many send XEC transaction with decimals`, () => {
    const destinationAddressAndValueArray = [
        'auscash:qrmz0egsqxj35x5jmzf8szrszdeu72fx0uxgwk3r48,1.23',
        'auscash:qq9h6d0a5q65fgywv4ry64x04ep906mdku8f0gxfgx,2.45',
        'auscash:qzvydd4n3lm3xv62cx078nu9rg0e3srmqq0knykfed,3.67',
    ];
